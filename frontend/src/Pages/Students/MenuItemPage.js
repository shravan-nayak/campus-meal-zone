    ...
    <nav className="bg-gray-900 text-white shadow-lg sticky top-0 z-50">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h5 className="text-amber-500 font-medium mb-2">Our Menu</h5>
          <h1 className="text-3xl font-bold">Browse All Items</h1>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {items.map((item) => (
            <div key={item.item_id} className="bg-gray-50 rounded-lg shadow-md overflow-hidden transition duration-300 hover:shadow-lg hover:transform hover:-translate-y-1">
              ...
              <div className="p-4">
                <div className="flex justify-between items-center border-b border-gray-200 pb-2 mb-2">
                  ...
                  <span className="text-amber-500 font-medium">₹{item.item_price}</span>
                </div>
